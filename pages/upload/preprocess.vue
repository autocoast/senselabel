    ...
    <div class="flex justify-center min-h-screen bg-base-200">
        <div
            ...
            <div class="card-body">
                ...
                <div class="m-2"></div>
                <h1 v-if="uploadStore.selectedSatellite === SatelliteType.sentinels2l2a || uploadStore.selectedSatellite === SatelliteType.sentinels2l1c"
                    class="text-2xl font-bold text-center text-primary dark:text-slate-300">Configure Sentinel S2</h1>
                <h1 v-if="uploadStore.selectedSatellite === SatelliteType.landsat8toa"
                    class="text-2xl font-bold text-center text-primary dark:text-slate-300">Configure Landsat 8</h1>
                <hr class="my-4">
                </hr>
